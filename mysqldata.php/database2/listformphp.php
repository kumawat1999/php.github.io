...
<head>
    ...
    if (isset($_REQUEST['save'])) {
        ...
        $insertdata = "INSERT INTO `listtable` (`name`,`lname`,`email`,`password`,`gender`,`city`)
                         VALUES ('$name', '$lname', '$email', '$password', '$gender', '$city')";
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="background-color: red;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="" placeholder="NAME" autocomplete="off">
                    </div>

                    <!-- last name -->
                    <div class="form-group">
                        <label for="">LAST NAME :</label>
                        <input type="text" class="form-control" name="lname" id="" placeholder="LAST NAME" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="" placeholder="EMAIL" autocomplete="off">
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        <input type="radio" name="gender" id="" value="MALE" required autocomplete="off"> MALE <BR>
                        <input type="radio" name="gender" id="" value="FEMALE" required autocomplete="off"> FEMALE <BR>
                        <input type="radio" name="gender" id="" value="OTHER" required autocomplete="off"> OTHER
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="city" id="" autocomplete="off">
